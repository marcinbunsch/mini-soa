...
java:
	javac -cp vendor/libthrift-0.9.1.jar:vendor/slf4j-api-1.7.5.jar gen-java/Resource.java gen-java/Service.java clients/Client.java
	java -cp vendor/libthrift-0.9.1.jar:vendor/slf4j-api-1.7.5.jar:gen-java:clients Client
